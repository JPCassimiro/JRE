...
class Ui_configForm(object):
    ...
    def retranslateUi(self, configForm):
        ...
        self.repeatHelperLabel.setToolTip(QCoreApplication.translate("configForm", u"Quando ligado, a entrada configurada ser\u00e1 repetida m\u00faltiplas vezes enquanto o sensor estiver ativado", u"ConfigScreenHelper"))
...
#if QT_CONFIG(tooltip)
        self.exhaleSelectButton.setToolTip(QCoreApplication.translate("configForm", u"Seleciona a tecla que deseja associar a entrada, caso j\u00e1 selecionada, apresenta a tecla escolhida", u"ConfigScreenHelper"))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.inhaleSelectButton.setToolTip(QCoreApplication.translate("configForm", u"Seleciona a tecla que deseja associar a entrada, caso j\u00e1 selecionada, apresenta a tecla escolhida", u"ConfigScreenHelper"))
#endif // QT_CONFIG(tooltip)
